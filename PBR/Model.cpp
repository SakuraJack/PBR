...
Mesh Model::processMesh(aiMesh* mesh, const aiScene* scene) {
	...
	vector<Texture> metallicMap = loadMaterialTextures(material, aiTextureType_SPECULAR, "texture_specular");
	...
	vector<Texture> aoMap = loadMaterialTextures(material, aiTextureType_LIGHTMAP, "texture_ao");
